		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="container">
					...
					<form:form id="form" class="form-horizontal" action="edit"
							...
							<div class="col-md-5">
								<%-- <div class="form-group">
									<label class="control-label col-sm-2" for="sex">Giới
										tính:</label>
									<div class="col-sm-10">
										<form:input type="text" class="form-control" path="sex"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:input type="password" class="form-control" path="password"
											placeholder="Nhập password" required="required" disabled="true"/>
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-5 col-sm-7"
								...
								<button type="submit" name="edit" class="btn btn-success">
									<span class="glyphicon glyphicon-plus">Cập nhật</span>
								</button>
